	...
	<div class="container">
		...
		<header class="row pt-5 pb-2">
			...
			<div class="col-3 text-right">
				<img src="mages/poly.png" alt="" class="w-50">
			</div>
		</header>
		<nav class="row">

			<nav class="col navbar navbar-expand-sm navbar-light bg-light">
				<a class="navbar-brand" href="#">PolyHub</a>
						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu" aria-labelledby="dropdownId">
								...
								<c:if test="${! isLogin }">
									...
									<a class="dropdown-item" href="VideosManagement">Videos Management</a>
